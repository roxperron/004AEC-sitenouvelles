...
<!--  <div class="mb-3">
   ...
   <select class="form-select" id="id_categorie" name="id_categorie"aria-label="Default select example" required>
 ...
 <button type="submit" name = "boutonSupprimer" class="btn btn-primary">Supprimer le film</button>
